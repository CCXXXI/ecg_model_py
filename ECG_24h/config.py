...
class Config:
    ...
    alldata_label = os.path.join(root, 'all_label_v1_1217.txt')  # 整个数据集的标签，包括测试集验证集训练集，在划分测试集时使用
    ...
    experiment_name = 'v1_lr1e-3_st16_32_64_warmup1e-5-8_bsz2560.005mv'  # 实验名称，会追加到保存模型的文件夹名
